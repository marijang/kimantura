...
add_action('b4b_before_header','b4b_before_header');

function b4b_before_header(){
    ?> 
...
add_action('b4b_after_footer','b4b_after_footer');
function b4b_after_footer(){
    ?> 
...
<?php
	...
	add_action( 'pre_get_posts1', function ( $q )
	{
